...
**Prerequisite**: Obtain your Project API Key by creating a project in [the Owl Protocol Dashboard](https://dashboard.owlprotocol.xyz/).

For guidance on retrieving your API Key, refer to [Get your Project API Key](/dashboard-docs/get-api-key).
