...
//Array types
export type ArrayTypeN<T extends NonTupleType = NonTupleType, N extends number = 1> = `${T}${RepeatString<"[]", N>}`;
...
//Zod validator
export type ZodForArrayType<T extends ArrayType> = T extends ArrayTypeN<infer U, 1>
    ? z.ZodArray<ZodForNonTupleType<U>>
    : T extends ArrayTypeN<infer U, 2>
    ? z.ZodArray<ZodForArrayType<ArrayTypeN<U, 1>>>
    : T extends ArrayTypeN<infer U, 3>
    ? z.ZodArray<ZodForArrayType<ArrayTypeN<U, 2>>>
    : T extends ArrayTypeN<infer U, 4>
    ? z.ZodArray<ZodForArrayType<ArrayTypeN<U, 3>>>
    : T extends ArrayTypeN<infer U, 5>
    ? z.ZodArray<ZodForArrayType<ArrayTypeN<U, 4>>>
    : never;
...
//String encode
export type ZodForArrayStringType<T extends ArrayType> = T extends ArrayTypeN<infer U, 1>
    ? z.ZodArray<ZodForNonTupleType<U>>
    : T extends ArrayTypeN<infer U, 2>
    ? z.ZodArray<ZodForArrayType<ArrayTypeN<U, 1>>>
    : T extends ArrayTypeN<infer U, 3>
