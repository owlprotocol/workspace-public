...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interfaces_IERC20_allowance_request_contractParams")]
    public partial class InterfacesIERC20AllowanceRequestContractParams : IEquatable<InterfacesIERC20AllowanceRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfacesIERC20AllowanceRequestContractParams" /> class.
        /// </summary>
        /// <param name="_0">An ethereum address.</param>
        /// <param name="_1">An ethereum address.</param>
        /// <param name="owner">An ethereum address.</param>
        /// <param name="spender">An ethereum address.</param>
        public InterfacesIERC20AllowanceRequestContractParams(string _0 = default(string), string _1 = default(string), string owner = default(string), string spender = default(string))
        {
            this._0 = _0;
            this._1 = _1;
            this.Owner = owner;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as InterfacesIERC20AllowanceRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if InterfacesIERC20AllowanceRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfacesIERC20AllowanceRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfacesIERC20AllowanceRequestContractParams input)
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            Regex regexSpender = new Regex(@"0x([a-fA-F0-9]){40}", RegexOptions.CultureInvariant);
