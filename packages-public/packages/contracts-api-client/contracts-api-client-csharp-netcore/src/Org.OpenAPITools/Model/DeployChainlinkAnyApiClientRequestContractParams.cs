...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deploy_ChainlinkAnyApiClient_request_contractParams")]
    public partial class DeployChainlinkAnyApiClientRequestContractParams : IEquatable<DeployChainlinkAnyApiClientRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployChainlinkAnyApiClientRequestContractParams" /> class.
        /// </summary>
        ...
        /// <param name="token">An ethereum address.</param>
        /// <param name="oracle">An ethereum address.</param>
        public DeployChainlinkAnyApiClientRequestContractParams(string _0 = default(string), string _1 = default(string), string _2 = default(string), string _3 = default(string), string admin = default(string), string initContractURI = default(string), string token = default(string), string oracle = default(string))
        {
            this._0 = _0;
            this._1 = _1;
            this._2 = _2;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as DeployChainlinkAnyApiClientRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if DeployChainlinkAnyApiClientRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of DeployChainlinkAnyApiClientRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeployChainlinkAnyApiClientRequestContractParams input)
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            Regex regexToken = new Regex(@"0x([a-fA-F0-9]){40}", RegexOptions.CultureInvariant);
            ...
            // Oracle (string) pattern
            Regex regexOracle = new Regex(@"0x([a-fA-F0-9]){40}", RegexOptions.CultureInvariant);
            if (false == regexOracle.Match(this.Oracle).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Oracle, must match a pattern of " + regexOracle, new [] { "Oracle" });
            }
