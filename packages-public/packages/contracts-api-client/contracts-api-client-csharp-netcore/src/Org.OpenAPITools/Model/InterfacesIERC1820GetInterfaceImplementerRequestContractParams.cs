...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interfaces_IERC1820_getInterfaceImplementer_request_contractParams")]
    public partial class InterfacesIERC1820GetInterfaceImplementerRequestContractParams : IEquatable<InterfacesIERC1820GetInterfaceImplementerRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfacesIERC1820GetInterfaceImplementerRequestContractParams" /> class.
        /// </summary>
        ...
        public InterfacesIERC1820GetInterfaceImplementerRequestContractParams(string _0 = default(string), string _1 = default(string), string account = default(string), string interfaceHash = default(string))
        {
            this._0 = _0;
            this._1 = _1;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as InterfacesIERC1820GetInterfaceImplementerRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if InterfacesIERC1820GetInterfaceImplementerRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfacesIERC1820GetInterfaceImplementerRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfacesIERC1820GetInterfaceImplementerRequestContractParams input)
        {
