...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interfaces_IERC2981_royaltyInfo_200_response_result")]
    public partial class InterfacesIERC2981RoyaltyInfo200ResponseResult : IEquatable<InterfacesIERC2981RoyaltyInfo200ResponseResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfacesIERC2981RoyaltyInfo200ResponseResult" /> class.
        /// </summary>
        ...
        /// <param name="royaltyAmount">A solidity uint256.</param>
        public InterfacesIERC2981RoyaltyInfo200ResponseResult(string _0 = default(string), string _1 = default(string), string receiver = default(string), string royaltyAmount = default(string))
        {
            this._0 = _0;
            this._1 = _1;
        ...
        /// </summary>
        /// <value>A solidity uint256</value>
        [DataMember(Name = "royaltyAmount", EmitDefaultValue = false)]
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as InterfacesIERC2981RoyaltyInfo200ResponseResult).AreEqual;
        }

        /// <summary>
        /// Returns true if InterfacesIERC2981RoyaltyInfo200ResponseResult instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfacesIERC2981RoyaltyInfo200ResponseResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfacesIERC2981RoyaltyInfo200ResponseResult input)
        {
