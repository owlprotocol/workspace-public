...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interfaces_IERC721_safeTransferFrom_request_contractParams")]
    public partial class InterfacesIERC721SafeTransferFromRequestContractParams : IEquatable<InterfacesIERC721SafeTransferFromRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfacesIERC721SafeTransferFromRequestContractParams" /> class.
        /// </summary>
        ...
        public InterfacesIERC721SafeTransferFromRequestContractParams(string _0 = default(string), string _1 = default(string), string _2 = default(string), string _3 = default(string), string from = default(string), string to = default(string), string tokenId = default(string), string data = default(string))
        {
            this._0 = _0;
            this._1 = _1;
            this._2 = _2;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as InterfacesIERC721SafeTransferFromRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if InterfacesIERC721SafeTransferFromRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfacesIERC721SafeTransferFromRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfacesIERC721SafeTransferFromRequestContractParams input)
        {
