...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deploy_TokenURIBaseURI_request_contractParams")]
    public partial class DeployTokenURIBaseURIRequestContractParams : IEquatable<DeployTokenURIBaseURIRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployTokenURIBaseURIRequestContractParams" /> class.
        /// </summary>
        ...
        public DeployTokenURIBaseURIRequestContractParams(string _0 = default(string), string _1 = default(string), string _2 = default(string), string _3 = default(string), string admin = default(string), string contractUri = default(string), string baseUriRole = default(string), string baseUri = default(string))
        {
            this._0 = _0;
            this._1 = _1;
            this._2 = _2;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as DeployTokenURIBaseURIRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if DeployTokenURIBaseURIRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of DeployTokenURIBaseURIRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeployTokenURIBaseURIRequestContractParams input)
        {
