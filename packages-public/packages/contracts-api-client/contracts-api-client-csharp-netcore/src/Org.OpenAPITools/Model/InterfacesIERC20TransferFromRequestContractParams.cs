...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interfaces_IERC20_transferFrom_request_contractParams")]
    public partial class InterfacesIERC20TransferFromRequestContractParams : IEquatable<InterfacesIERC20TransferFromRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfacesIERC20TransferFromRequestContractParams" /> class.
        /// </summary>
        ...
        public InterfacesIERC20TransferFromRequestContractParams(string _0 = default(string), string _1 = default(string), string _2 = default(string), string from = default(string), string to = default(string), string amount = default(string))
        {
            this._0 = _0;
            this._1 = _1;
            this._2 = _2;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as InterfacesIERC20TransferFromRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if InterfacesIERC20TransferFromRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfacesIERC20TransferFromRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfacesIERC20TransferFromRequestContractParams input)
        {
