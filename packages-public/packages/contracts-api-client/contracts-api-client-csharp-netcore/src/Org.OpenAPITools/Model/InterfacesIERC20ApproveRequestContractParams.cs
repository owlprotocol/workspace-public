...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interfaces_IERC20_approve_request_contractParams")]
    public partial class InterfacesIERC20ApproveRequestContractParams : IEquatable<InterfacesIERC20ApproveRequestContractParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfacesIERC20ApproveRequestContractParams" /> class.
        /// </summary>
        ...
        public InterfacesIERC20ApproveRequestContractParams(string _0 = default(string), string _1 = default(string), string spender = default(string), string amount = default(string))
        {
            this._0 = _0;
            this._1 = _1;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as InterfacesIERC20ApproveRequestContractParams).AreEqual;
        }

        /// <summary>
        /// Returns true if InterfacesIERC20ApproveRequestContractParams instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfacesIERC20ApproveRequestContractParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfacesIERC20ApproveRequestContractParams input)
        {
