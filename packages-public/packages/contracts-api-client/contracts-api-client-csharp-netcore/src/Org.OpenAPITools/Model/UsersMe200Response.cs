...
namespace Org.OpenAPITools.Model
{
    ...
    /// UsersMe200Response
    /// </summary>
    [DataContract(Name = "users_me_200_response")]
    public partial class UsersMe200Response : IEquatable<UsersMe200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersMe200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsersMe200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersMe200Response" /> class.
        /// </summary>
        ...
        public UsersMe200Response(string email = default(string), string apiKey = default(string), string dfnsAddress = default(string), string dfnsId = default(string), string dfnsStatus = default(string), string gnosisTxHash = default(string), string gnosisAddress = default(string), Object topupTotals = default(Object))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for UsersMe200Response and cannot be null");
            }
            this.Email = email;
            // to ensure "apiKey" is required (not null)
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for UsersMe200Response and cannot be null");
            }
            this.ApiKey = apiKey;
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as UsersMe200Response).AreEqual;
        }

        /// <summary>
        /// Returns true if UsersMe200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersMe200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersMe200Response input)
        {
