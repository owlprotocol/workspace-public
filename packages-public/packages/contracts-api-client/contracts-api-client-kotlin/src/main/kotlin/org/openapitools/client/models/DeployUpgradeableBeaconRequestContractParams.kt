 ...
 * @param implementation An ethereum address
 */


data class DeployUpgradeableBeaconRequestContractParams (
    ...
    /* An ethereum address */
    @Json(name = "implementation_")
    val implementation: kotlin.String? = null
