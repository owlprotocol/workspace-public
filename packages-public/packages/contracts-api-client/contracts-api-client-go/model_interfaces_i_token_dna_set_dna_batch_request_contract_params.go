...
// checks if the InterfacesITokenDnaSetDnaBatchRequestContractParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfacesITokenDnaSetDnaBatchRequestContractParams{}

// InterfacesITokenDnaSetDnaBatchRequestContractParams struct for InterfacesITokenDnaSetDnaBatchRequestContractParams
type InterfacesITokenDnaSetDnaBatchRequestContractParams struct {
...
func NewInterfacesITokenDnaSetDnaBatchRequestContractParams() *InterfacesITokenDnaSetDnaBatchRequestContractParams {
	this := InterfacesITokenDnaSetDnaBatchRequestContractParams{}
	return &this
}
...
func (o InterfacesITokenDnaSetDnaBatchRequestContractParams) MarshalJSON() ([]byte, error) {
...
func (o InterfacesITokenDnaSetDnaBatchRequestContractParams) ToMap() (map[string]interface{}, error) {
...
type NullableInterfacesITokenDnaSetDnaBatchRequestContractParams struct {
	value *InterfacesITokenDnaSetDnaBatchRequestContractParams
	isSet bool
}

func (v NullableInterfacesITokenDnaSetDnaBatchRequestContractParams) Get() *InterfacesITokenDnaSetDnaBatchRequestContractParams {
	return v.value
}

func (v *NullableInterfacesITokenDnaSetDnaBatchRequestContractParams) Set(val *InterfacesITokenDnaSetDnaBatchRequestContractParams) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfacesITokenDnaSetDnaBatchRequestContractParams) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfacesITokenDnaSetDnaBatchRequestContractParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfacesITokenDnaSetDnaBatchRequestContractParams(val *InterfacesITokenDnaSetDnaBatchRequestContractParams) *NullableInterfacesITokenDnaSetDnaBatchRequestContractParams {
	return &NullableInterfacesITokenDnaSetDnaBatchRequestContractParams{value: val, isSet: true}
}

func (v NullableInterfacesITokenDnaSetDnaBatchRequestContractParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfacesITokenDnaSetDnaBatchRequestContractParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
