...
// checks if the InterfacesIERC20Allowance200ResponseResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfacesIERC20Allowance200ResponseResult{}

// InterfacesIERC20Allowance200ResponseResult struct for InterfacesIERC20Allowance200ResponseResult
type InterfacesIERC20Allowance200ResponseResult struct {
	// A solidity uint256
...
func NewInterfacesIERC20Allowance200ResponseResult() *InterfacesIERC20Allowance200ResponseResult {
	this := InterfacesIERC20Allowance200ResponseResult{}
	return &this
}
...
func (o InterfacesIERC20Allowance200ResponseResult) MarshalJSON() ([]byte, error) {
...
func (o InterfacesIERC20Allowance200ResponseResult) ToMap() (map[string]interface{}, error) {
...
type NullableInterfacesIERC20Allowance200ResponseResult struct {
	value *InterfacesIERC20Allowance200ResponseResult
	isSet bool
}

func (v NullableInterfacesIERC20Allowance200ResponseResult) Get() *InterfacesIERC20Allowance200ResponseResult {
	return v.value
}

func (v *NullableInterfacesIERC20Allowance200ResponseResult) Set(val *InterfacesIERC20Allowance200ResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfacesIERC20Allowance200ResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfacesIERC20Allowance200ResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfacesIERC20Allowance200ResponseResult(val *InterfacesIERC20Allowance200ResponseResult) *NullableInterfacesIERC20Allowance200ResponseResult {
	return &NullableInterfacesIERC20Allowance200ResponseResult{value: val, isSet: true}
}

func (v NullableInterfacesIERC20Allowance200ResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfacesIERC20Allowance200ResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
