...
// checks if the InterfacesIERC1155SafeBatchTransferFromRequestContractParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfacesIERC1155SafeBatchTransferFromRequestContractParams{}

// InterfacesIERC1155SafeBatchTransferFromRequestContractParams struct for InterfacesIERC1155SafeBatchTransferFromRequestContractParams
type InterfacesIERC1155SafeBatchTransferFromRequestContractParams struct {
	// An ethereum address
...
func NewInterfacesIERC1155SafeBatchTransferFromRequestContractParams() *InterfacesIERC1155SafeBatchTransferFromRequestContractParams {
	this := InterfacesIERC1155SafeBatchTransferFromRequestContractParams{}
	return &this
}
...
func (o *InterfacesIERC1155SafeBatchTransferFromRequestContractParams) GetVar0Ok() (*string, bool) {
	if o == nil || IsNil(o.Var0) {
		return nil, false
	}
	return o.Var0, true
...
func (o *InterfacesIERC1155SafeBatchTransferFromRequestContractParams) GetData() string {
...
func (o InterfacesIERC1155SafeBatchTransferFromRequestContractParams) MarshalJSON() ([]byte, error) {
...
func (o InterfacesIERC1155SafeBatchTransferFromRequestContractParams) ToMap() (map[string]interface{}, error) {
...
type NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams struct {
	value *InterfacesIERC1155SafeBatchTransferFromRequestContractParams
	isSet bool
}

func (v NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams) Get() *InterfacesIERC1155SafeBatchTransferFromRequestContractParams {
	return v.value
}

func (v *NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams) Set(val *InterfacesIERC1155SafeBatchTransferFromRequestContractParams) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams(val *InterfacesIERC1155SafeBatchTransferFromRequestContractParams) *NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams {
	return &NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams{value: val, isSet: true}
}

func (v NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfacesIERC1155SafeBatchTransferFromRequestContractParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
