...
// checks if the InterfacesIContractURIContractURI200ResponseResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfacesIContractURIContractURI200ResponseResult{}

// InterfacesIContractURIContractURI200ResponseResult struct for InterfacesIContractURIContractURI200ResponseResult
type InterfacesIContractURIContractURI200ResponseResult struct {
	// A string
...
func NewInterfacesIContractURIContractURI200ResponseResult() *InterfacesIContractURIContractURI200ResponseResult {
	this := InterfacesIContractURIContractURI200ResponseResult{}
	return &this
}
...
func (o InterfacesIContractURIContractURI200ResponseResult) MarshalJSON() ([]byte, error) {
...
func (o InterfacesIContractURIContractURI200ResponseResult) ToMap() (map[string]interface{}, error) {
...
type NullableInterfacesIContractURIContractURI200ResponseResult struct {
	value *InterfacesIContractURIContractURI200ResponseResult
	isSet bool
}

func (v NullableInterfacesIContractURIContractURI200ResponseResult) Get() *InterfacesIContractURIContractURI200ResponseResult {
	return v.value
}

func (v *NullableInterfacesIContractURIContractURI200ResponseResult) Set(val *InterfacesIContractURIContractURI200ResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfacesIContractURIContractURI200ResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfacesIContractURIContractURI200ResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfacesIContractURIContractURI200ResponseResult(val *InterfacesIContractURIContractURI200ResponseResult) *NullableInterfacesIContractURIContractURI200ResponseResult {
	return &NullableInterfacesIContractURIContractURI200ResponseResult{value: val, isSet: true}
}

func (v NullableInterfacesIContractURIContractURI200ResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfacesIContractURIContractURI200ResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
