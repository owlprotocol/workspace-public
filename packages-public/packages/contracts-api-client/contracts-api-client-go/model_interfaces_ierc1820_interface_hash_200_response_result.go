...
// checks if the InterfacesIERC1820InterfaceHash200ResponseResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfacesIERC1820InterfaceHash200ResponseResult{}

// InterfacesIERC1820InterfaceHash200ResponseResult struct for InterfacesIERC1820InterfaceHash200ResponseResult
type InterfacesIERC1820InterfaceHash200ResponseResult struct {
	// A solidity bytes32
...
func NewInterfacesIERC1820InterfaceHash200ResponseResult() *InterfacesIERC1820InterfaceHash200ResponseResult {
	this := InterfacesIERC1820InterfaceHash200ResponseResult{}
	return &this
}
...
func (o InterfacesIERC1820InterfaceHash200ResponseResult) MarshalJSON() ([]byte, error) {
...
func (o InterfacesIERC1820InterfaceHash200ResponseResult) ToMap() (map[string]interface{}, error) {
...
type NullableInterfacesIERC1820InterfaceHash200ResponseResult struct {
	value *InterfacesIERC1820InterfaceHash200ResponseResult
	isSet bool
}

func (v NullableInterfacesIERC1820InterfaceHash200ResponseResult) Get() *InterfacesIERC1820InterfaceHash200ResponseResult {
	return v.value
}

func (v *NullableInterfacesIERC1820InterfaceHash200ResponseResult) Set(val *InterfacesIERC1820InterfaceHash200ResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfacesIERC1820InterfaceHash200ResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfacesIERC1820InterfaceHash200ResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfacesIERC1820InterfaceHash200ResponseResult(val *InterfacesIERC1820InterfaceHash200ResponseResult) *NullableInterfacesIERC1820InterfaceHash200ResponseResult {
	return &NullableInterfacesIERC1820InterfaceHash200ResponseResult{value: val, isSet: true}
}

func (v NullableInterfacesIERC1820InterfaceHash200ResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfacesIERC1820InterfaceHash200ResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
