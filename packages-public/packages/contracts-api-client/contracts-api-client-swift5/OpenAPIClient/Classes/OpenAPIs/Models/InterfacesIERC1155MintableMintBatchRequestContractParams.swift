//
// InterfacesIERC1155MintableMintBatchRequestContractParams.swift
//
...
public struct InterfacesIERC1155MintableMintBatchRequestContractParams: Codable, JSONEncodable, Hashable {
    ...
    public init(_0: String? = nil, _1: [String]? = nil, _2: [String]? = nil, _3: String? = nil, to: String? = nil, ids: [String]? = nil, amounts: [String]? = nil, data: String? = nil) {
        self._0 = _0
        self._1 = _1
        self._2 = _2
        self._3 = _3
