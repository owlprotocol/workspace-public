//
// InterfacesIERC2981RoyaltyInfo200ResponseResult.swift
//
...
public struct InterfacesIERC2981RoyaltyInfo200ResponseResult: Codable, JSONEncodable, Hashable {
    ...
    /** A solidity uint256 */
    public var royaltyAmount: String?

    public init(_0: String? = nil, _1: String? = nil, receiver: String? = nil, royaltyAmount: String? = nil) {
        self._0 = _0
        self._1 = _1
