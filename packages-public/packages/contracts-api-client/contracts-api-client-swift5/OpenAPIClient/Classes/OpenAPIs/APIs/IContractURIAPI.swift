...
open class IContractURIAPI {
     ...
     */
    @discardableResult
    open class func interfacesIContractURIContractURI(networkId: String, address: String, interfacesIBeaconImplementationRequest: InterfacesIBeaconImplementationRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: InterfacesIContractURIContractURI200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return interfacesIContractURIContractURIWithRequestBuilder(networkId: networkId, address: address, interfacesIBeaconImplementationRequest: interfacesIBeaconImplementationRequest).execute(apiResponseQueue) { result in
            switch result {
    ...
    /**
     IContractURI.contractURI
     - POST /{networkId}/interface/IContractURI/read/{address}/contractURI
     ...
     */
    open class func interfacesIContractURIContractURIWithRequestBuilder(networkId: String, address: String, interfacesIBeaconImplementationRequest: InterfacesIBeaconImplementationRequest) -> RequestBuilder<InterfacesIContractURIContractURI200Response> {
        var localVariablePath = "/{networkId}/interface/IContractURI/read/{address}/contractURI"
     ...
     */
    @discardableResult
    open class func interfacesIContractURISetContractURI(networkId: String, address: String, interfacesIContractURISetContractURIRequest: InterfacesIContractURISetContractURIRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: InterfacesIContractURISetContractURI200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return interfacesIContractURISetContractURIWithRequestBuilder(networkId: networkId, address: address, interfacesIContractURISetContractURIRequest: interfacesIContractURISetContractURIRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     IContractURI.setContractURI
     - POST /{networkId}/interface/IContractURI/write/{address}/setContractURI
     ...
     */
    open class func interfacesIContractURISetContractURIWithRequestBuilder(networkId: String, address: String, interfacesIContractURISetContractURIRequest: InterfacesIContractURISetContractURIRequest) -> RequestBuilder<InterfacesIContractURISetContractURI200Response> {
        var localVariablePath = "/{networkId}/interface/IContractURI/write/{address}/setContractURI"
        let networkIdPreEscape = "\(APIHelper.mapValueToPathItem(networkId))"
        let networkIdPostEscape = networkIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{networkId}", with: networkIdPostEscape, options: .literal, range: nil)
        let addressPreEscape = "\(APIHelper.mapValueToPathItem(address))"
