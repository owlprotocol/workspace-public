...
pub struct InterfacesIerc20TransferFromRequestContractParams {
    /// An ethereum address
...
impl InterfacesIerc20TransferFromRequestContractParams {
    pub fn new() -> InterfacesIerc20TransferFromRequestContractParams {
