...
import { sameString } from "./utils/address.js";
...
export function generatePreValidatedSignature(ownerAddress: string): SafeSignature {
    ...
    return { signer: ownerAddress, data: signature };
}
...
export async function generateSignature(signer: Signer, hash: string): Promise<SafeSignature> {
