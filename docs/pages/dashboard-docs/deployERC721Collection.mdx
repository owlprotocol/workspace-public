...
# Deploy an Owl ERC721 Collection
...
The collectibles that you mint will appear under "Digital Items". Any templates that you define will be listed under "Templates". (See [➕ Create a Template & Mint to Users](doc:mint-from-item-type))
...
-   [Create a Template & Mint to Users](/dashboard-docs/createItemTypeAndMint)
