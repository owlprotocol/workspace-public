...
These features make the transition to blockchain technologies accessible for all users and improve usability from current users with additional features.
