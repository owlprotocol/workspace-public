...
In this tutorial, we will mint an asset to a user. We will use the demo project deployed in [Deploy Your First Demo Project](/tutorials-dashboard/deploy-demo-project), add a user, and mint an asset to them from a template. Note that templates allow you to easily mint the same asset for multiple users.
...
Once you are done exploring the demo project, you can [Deploy Your Custom Project](/tutorials-dashboard/deploy-custom-project)
