...
We recommend you to start by deploying a demo project to familiarize yourself with our dashboard (see: [Deploy Your First Demo Project](/tutorials-dashboard/deploy-demo-project)).
