...
Deploy an ERC721 Collection with custom metadata in just a few clicks.
...
The collectibles that you mint will appear under "Digital Items". Any templates that you define will be listed under "Templates". (See [Create a Template & Mint to Users](/tutorials-dashboard/create-template-and-mint))
...
-   [Add Project Users](/tutorials-dashboard/add-project-users)
-   [Create A Template & Mint To Users](/tutorials-dashboard/create-template-and-mint)
