...
Discover all the collections created within this project.. Click **`View Details`** for a closer look at a specific collection, or use the **`Show Templates`** button to reveal a table listing the pre-defined templates for that collection.
