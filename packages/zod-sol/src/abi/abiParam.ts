...
import {
    ...
    isAbiParamTupleArray,
    zodForAbiParamTupleArray,
} from "./abiParamTupleArray.js";

/** Abi Function Parameters Tuple */
export type AbiParam = AbiParamNonTuple | AbiParamArray | AbiParamTuple | AbiParamTupleArray;

/** Zod for any param */
export type ZodForAbiParam<T extends AbiParam> = T extends AbiParamNonTuple
    ? ZodForNonTupleType<T["type"]>
    : T extends AbiParamArray
    ? ZodForArrayType<T["type"]>
    : T extends AbiParamTuple
    ? ZodForAbiParamTuple<T>
    : T extends AbiParamTupleArray
    ? ZodForAbiParamTupleArray<T>
    : never;
